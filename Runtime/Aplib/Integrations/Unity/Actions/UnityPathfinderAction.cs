...
namespace Aplib.Integrations.Unity.Actions
{
        ...
        where TBeliefSet : IBeliefSet
    {
        public UnityPathfinderAction(
            ...
            : this(objectQuery, location: ConstantLocation(location), effect, heightOffset, metadata)
        {
        }
        ...
        public UnityPathfinderAction(
            ...
            float heightOffset = 0f,
            Metadata metadata = null)
            : base(PathfindingAction(objectQuery, location, effect, heightOffset: heightOffset), metadata)
        {
        }
